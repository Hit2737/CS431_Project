...
string sendMessageToServer(const string &message, const string &ip, int port)
{
    ...
    // Value jsonMessage;
    // jsonMessage["key"] = encryptUsingPublicKey(SYM_KEY);
    // jsonMessage["iv"] = encryptUsingPublicKey(IV);
    // jsonMessage["mode"] = "k";
    // StreamWriterBuilder writer;
    // string key_iv_message = writeString(writer, jsonMessage);
    ...
    if (n > 0)
    {
        ...
        cout << "Second response from the Bank Server: " << string(buffer) << endl;
    }
    else
    {
    ...
    close(sockfd);
    return string(buffer); // Return the second server response
}
// ................................  ATM FUNCTIONALITIES ................................
